...
function dynamicContentDetails(ob) {
  ...
  let h3DetailsText = document.createTextNode("Preço R$ " + ob.price);
  h3DetailsDiv.appendChild(h3DetailsText);

  let h3 = document.createElement("h3");
  let h3Text = document.createTextNode("Descrição do produto");
  ...
  let h3Text1 = document.createTextNode(
  ...
  let h3ProductPreviewText = document.createTextNode("Detalhes do produto");
  ...
  buttonText = document.createTextNode("Adicionar ao carrinho");
...
httpRequest.open(
  "GET",
  "https://62e523ecc6b56b45118f9a7d.mockapi.io/produtos/content/" + id,
  true
);
httpRequest.send();
